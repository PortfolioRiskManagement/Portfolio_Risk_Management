...
export default function AlertsPage({ 
	...
	return (
		<div className="space-y-6">
			<div>
				<h1 className="text-3xl font-bold text-white mb-2">Portfolio Alerts</h1>
				<p className="text-zinc-400">Market news and alerts impacting your holdings</p>
			</div>
			...
			<div className="space-y-3">
				...
				{filter === "my-holdings" && portfolioHoldings.length > 0 && (
					<div className="flex items-center gap-2">
						<label className="text-sm text-zinc-400">Filter by holding:</label>
						<select
							value={selectedTicker}
							onChange={(e) => setSelectedTicker(e.target.value)}
							className="px-3 py-2 rounded-lg bg-zinc-700 text-white border border-zinc-600 focus:outline-none focus:border-indigo-500"
						>
			...
			{!loading && getCurrentAlerts().length > 0 && (
				<div className="grid grid-cols-4 gap-4 pt-6 border-t border-zinc-700">
					<div className="bg-zinc-800/50 rounded-lg p-4">
						<p className="text-zinc-400 text-xs mb-1">Total News</p>
					...
					<div className="bg-red-900/20 rounded-lg p-4 border border-red-800/30">
						<p className="text-zinc-400 text-xs mb-1">High Impact</p>
					...
					<div className="bg-yellow-900/20 rounded-lg p-4 border border-yellow-800/30">
						<p className="text-zinc-400 text-xs mb-1">Medium Impact</p>
					...
					<div className="bg-blue-900/20 rounded-lg p-4 border border-blue-800/30">
						<p className="text-zinc-400 text-xs mb-1">Low Impact</p>
